...
__swi __arm void DISP_DESC_SetOnLayout( DISP_DESC*, DISP_OBJ_ONLAYOUT_METHOD );//T
...
/*
#pragma swi_number=0x3DB
__swi __arm

#pragma swi_number=0x3DC
__swi __arm
  */
...
//__swi __arm void DispObject_ShowScrollBar( DISP_OBJ*, int mode );
/*
wchar_t * DispObj_StringInput_GetString( DISP_OBJ * );

#pragma swi_number=0x3DF
__swi __arm u16 DispObj_StringInput_GetStringLen( DISP_OBJ *do_string_input );
*/
#pragma swi_number=0x3E0
__swi __arm void Clipboard_SetText( wchar_t *text, int len );
#pragma swi_number=0x3E1
__swi __arm int Clipboard_GetText( wchar_t **text );

#pragma swi_number=0x3E2
__swi __arm int Clipboard_ExistsText( void );

//--------------------


//#pragma swi_number=0x3dc
//__swi __arm void Registry_Write(char* name, int type, int size, void* data)
//#pragma swi_number=0x3E4
//__swi __arm int Registry_Read(char* name, int type, int size, void* data)
